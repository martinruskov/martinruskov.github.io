...
var MapEventManager = class {
  ...
  constructor(_ngZone) {
    ...
    this._pending = [];
    this._listeners = [];
    this._targetStream = new import_rxjs.BehaviorSubject(void 0);
  }
  /** Gets an observable that adds an event listener to the map when a consumer subscribes to it. */
  getLazyEmitter(name) {
    return this._targetStream.pipe((0, import_operators.switchMap)((target) => {
      const observable = new import_rxjs.Observable((observer) => {
        if (!target) {
          this._pending.push({
            observable,
            observer
...
var GoogleMap = class _GoogleMap {
  ...
  _resolveMap() {
    return this.googleMap ? Promise.resolve(this.googleMap) : this.mapInitialized.pipe((0, import_operators.take)(1)).toPromise();
  }
  _setSize() {
    if (this._mapEl) {
...
var MapCircle = class _MapCircle {
  ...
  constructor(_map, _ngZone) {
    ...
    this._ngZone = _ngZone;
    this._eventManager = new MapEventManager(inject(NgZone));
    this._options = new import_rxjs.BehaviorSubject({});
    this._center = new import_rxjs.BehaviorSubject(void 0);
    this._radius = new import_rxjs.BehaviorSubject(void 0);
  ...
  ngOnInit() {
    ...
    this._combineOptions().pipe((0, import_operators.take)(1)).subscribe((options) => {
  ...
  _combineOptions() {
    return (0, import_rxjs.combineLatest)([this._options, this._center, this._radius]).pipe((0, import_operators.map)(([options, center, radius]) => {
  ...
  _watchForOptionsChanges() {
    this._options.pipe((0, import_operators.takeUntil)(this._destroyed)).subscribe((options) => {
      this._assertInitialized();
      this.circle.setOptions(options);
    });
  }
  _watchForCenterChanges() {
    this._center.pipe((0, import_operators.takeUntil)(this._destroyed)).subscribe((center) => {
      if (center) {
        this._assertInitialized();
  ...
  _watchForRadiusChanges() {
    this._radius.pipe((0, import_operators.takeUntil)(this._destroyed)).subscribe((radius) => {
      if (radius !== void 0) {
        this._assertInitialized();
...
var MapGroundOverlay = class _MapGroundOverlay {
  ...
  constructor(_map, _ngZone) {
    ...
    this._ngZone = _ngZone;
    this._eventManager = new MapEventManager(inject(NgZone));
    this._opacity = new import_rxjs.BehaviorSubject(1);
    this._url = new import_rxjs.BehaviorSubject("");
    this._bounds = new import_rxjs.BehaviorSubject(void 0);
    this._destroyed = new import_rxjs.Subject();
  ...
  ngOnInit() {
    if (this._map._isBrowser) {
      this._bounds.pipe((0, import_operators.takeUntil)(this._destroyed)).subscribe((bounds) => {
  ...
  _watchForOpacityChanges() {
    this._opacity.pipe((0, import_operators.takeUntil)(this._destroyed)).subscribe((opacity) => {
      if (opacity != null) {
  ...
  _watchForUrlChanges() {
    this._url.pipe((0, import_operators.takeUntil)(this._destroyed)).subscribe((url) => {
...
var MapInfoWindow = class _MapInfoWindow {
  ...
  constructor(_googleMap, _elementRef, _ngZone) {
    ...
    this._eventManager = new MapEventManager(inject(NgZone));
    this._options = new import_rxjs.BehaviorSubject({});
    this._position = new import_rxjs.BehaviorSubject(void 0);
  ...
  _combineOptions() {
    return (0, import_rxjs.combineLatest)([this._options, this._position]).pipe((0, import_operators.map)(([options, position]) => {
      const combinedOptions = __spreadProps(__spreadValues({}, options), {
  ...
  _watchForOptionsChanges() {
    this._options.pipe((0, import_operators.takeUntil)(this._destroy)).subscribe((options) => {
      this._assertInitialized();
      this.infoWindow.setOptions(options);
    });
  }
  _watchForPositionChanges() {
    this._position.pipe((0, import_operators.takeUntil)(this._destroy)).subscribe((position) => {
      if (position) {
        this._assertInitialized();
...
var MapKmlLayer = class _MapKmlLayer {
  ...
  _combineOptions() {
    return (0, import_rxjs.combineLatest)([this._options, this._url]).pipe((0, import_operators.map)(([options, url]) => {
      const combinedOptions = __spreadProps(__spreadValues({}, options), {
        url: url || options.url
      });
      return combinedOptions;
...
var MapMarker = class _MapMarker {
  ...
  _resolveMarker() {
    return this.marker ? Promise.resolve(this.marker) : this.markerInitialized.pipe((0, import_operators.take)(1)).toPromise();
  }
...
var MapMarkerClusterer = class _MapMarkerClusterer {
  ...
  ngAfterContentInit() {
    if (this._canInitialize) {
      if (this.markerClusterer) {
        ...
        this.markerClustererInitialized.pipe((0, import_operators.take)(1), (0, import_operators.takeUntil)(this._destroy)).subscribe(() => this._watchForMarkerChanges());
      }
    }
  }
  ngOnChanges(changes) {
  ...
  _watchForMarkerChanges() {
    ...
    this._markers.changes.pipe((0, import_operators.takeUntil)(this._destroy)).subscribe((markerComponents) => {
      this._assertInitialized();
      this._ngZone.runOutsideAngular(() => {
...
var MapPolygon = class _MapPolygon {
  ...
  constructor(_map, _ngZone) {
    ...
    this._eventManager = new MapEventManager(inject(NgZone));
    this._options = new import_rxjs.BehaviorSubject({});
    this._paths = new import_rxjs.BehaviorSubject(void 0);
    this._destroyed = new import_rxjs.Subject();
  ...
  _combineOptions() {
    return (0, import_rxjs.combineLatest)([this._options, this._paths]).pipe((0, import_operators.map)(([options, paths]) => {
      const combinedOptions = __spreadProps(__spreadValues({}, options), {
  ...
  _watchForPathChanges() {
    this._paths.pipe((0, import_operators.takeUntil)(this._destroyed)).subscribe((paths) => {
      if (paths) {
        this._assertInitialized();
...
var MapPolyline = class _MapPolyline {
  ...
  constructor(_map, _ngZone) {
    ...
    this._eventManager = new MapEventManager(inject(NgZone));
    this._options = new import_rxjs.BehaviorSubject({});
    this._path = new import_rxjs.BehaviorSubject(void 0);
    this._destroyed = new import_rxjs.Subject();
  ...
  _combineOptions() {
    return (0, import_rxjs.combineLatest)([this._options, this._path]).pipe((0, import_operators.map)(([options, path]) => {
      const combinedOptions = __spreadProps(__spreadValues({}, options), {
  ...
  _watchForPathChanges() {
    this._path.pipe((0, import_operators.takeUntil)(this._destroyed)).subscribe((path) => {
      if (path) {
        this._assertInitialized();
...
var MapRectangle = class _MapRectangle {
  ...
  _combineOptions() {
    return (0, import_rxjs.combineLatest)([this._options, this._bounds]).pipe((0, import_operators.map)(([options, bounds]) => {
      const combinedOptions = __spreadProps(__spreadValues({}, options), {
...
var MapTrafficLayer = class _MapTrafficLayer {
  ...
  constructor(_map, _ngZone) {
    this._map = _map;
    this._ngZone = _ngZone;
    this._autoRefresh = new import_rxjs.BehaviorSubject(true);
    this._destroyed = new import_rxjs.Subject();
  ...
  _combineOptions() {
    return this._autoRefresh.pipe((0, import_operators.map)((autoRefresh) => {
  ...
  _watchForAutoRefreshChanges() {
    this._combineOptions().pipe((0, import_operators.takeUntil)(this._destroyed)).subscribe((options) => {
      this._assertInitialized();
