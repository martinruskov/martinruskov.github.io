...
var NzConnectedOverlayDirective = class _NzConnectedOverlayDirective {
  constructor(cdkConnectedOverlay, nzDestroyService) {
    ...
    this.cdkConnectedOverlay.positionChange.pipe((0, import_operators3.takeUntil)(this.nzDestroyService)).subscribe((position) => {
...
var NzSubmenuService = class _NzSubmenuService {
  ...
  constructor(nzMenuService) {
    ...
    this.mode$ = this.nzMenuService.mode$.pipe((0, import_operators4.map)((mode) => {
      if (mode === "inline") {
        return "inline";
    ...
    const isClosedByMenuItemClick = this.childMenuItemClick$.pipe((0, import_operators4.mergeMap)(() => this.mode$), (0, import_operators4.filter)((mode) => mode !== "inline" || this.isMenuInsideDropDown), (0, import_operators4.mapTo)(false));
...
var NzMenuItemComponent = class _NzMenuItemComponent {
  ...
  ngOnInit() {
    (0, import_rxjs4.combineLatest)([this.nzMenuService.mode$, this.nzMenuService.inlineIndent$]).pipe((0, import_operators4.takeUntil)(this.destroy$)).subscribe(([mode, inlineIndent]) => {
...
var NzSubMenuComponent = class _NzSubMenuComponent {
  ...
  ngOnInit() {
    this.nzMenuService.theme$.pipe((0, import_operators4.takeUntil)(this.destroy$)).subscribe((theme) => {
      this.theme = theme;
      this.cdr.markForCheck();
    });
    this.nzSubmenuService.mode$.pipe((0, import_operators4.takeUntil)(this.destroy$)).subscribe((mode) => {
      this.mode = mode;
      if (mode === "horizontal") {
    ...
    (0, import_rxjs4.combineLatest)([this.nzSubmenuService.mode$, this.nzMenuService.inlineIndent$]).pipe((0, import_operators4.takeUntil)(this.destroy$)).subscribe(([mode, inlineIndent]) => {
      this.inlinePaddingLeft = mode === "inline" ? this.level * inlineIndent : null;
      this.cdr.markForCheck();
    });
    this.nzSubmenuService.isCurrentSubMenuOpen$.pipe((0, import_operators4.takeUntil)(this.destroy$)).subscribe((open) => {
      this.isActive = open;
      if (open !== this.nzOpen) {
  ...
  ngAfterContentInit() {
    ...
    const mergedObservable = (0, import_rxjs4.merge)(...[changes, ...listOfNzMenuItemDirective.map((menu) => menu.selected$)]);
    changes.pipe((0, import_operators4.startWith)(listOfNzMenuItemDirective), (0, import_operators4.switchMap)(() => mergedObservable), (0, import_operators4.startWith)(true), (0, import_operators4.map)(() => listOfNzMenuItemDirective.some((e) => e.nzSelected)), (0, import_operators4.takeUntil)(this.destroy$)).subscribe((selected) => {
...
var NzMenuDirective = class _NzMenuDirective {
  ...
  constructor(nzMenuService, cdr) {
    ...
    this.dir = "ltr";
    this.inlineCollapsed$ = new import_rxjs4.BehaviorSubject(this.nzInlineCollapsed);
    this.mode$ = new import_rxjs4.BehaviorSubject(this.nzMode);
    this.destroy$ = new import_rxjs4.Subject();
    this.listOfOpenedNzSubMenuComponent = [];
    this.directionality = inject(Directionality);
  }
  ngOnInit() {
    ...
    this.nzMenuService.descendantMenuItemClick$.pipe((0, import_operators4.takeUntil)(this.destroy$)).subscribe((menu) => {
...
//# sourceMappingURL=chunk-JNT5QBO3.js.map
